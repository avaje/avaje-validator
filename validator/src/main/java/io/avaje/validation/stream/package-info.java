/**
 * Default stream handling provided with Validator.
 * <p>
 * This implementation is provided by default as it is known to perform faster
 * than Jackson's BaseValidator/JsonGenerator that comes with <code>jackson-core</code>.
 * <p>
 ...
 * and generation.
 *
 * @see io.avaje.validation.stream.JsonStream
 */
